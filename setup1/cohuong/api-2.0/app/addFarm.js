...
const invokeTransaction = async (channelName, chaincodeName, email, name, description, address, phone, emailfarm, website, facebook, logo, location) => {
    try {
        ...
        result = await contract.submitTransaction(
            'registerNongTrai',
            name, description, address, phone, emailfarm, website, facebook, logo
            , location
        )
