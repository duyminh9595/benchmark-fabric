...
const invokeTransaction = async (channelName, chaincodeName, plantingseason, email, fertilizerType, description) => {
    try {
        ...
        result = await contract.submitTransaction(
            'createFertilizing',
            plantingseason, email, fertilizerType, description
        )
