...
createChannel(){
    ...
    peer channel create -o 130.211.113.30:7050 -c $CHANNEL_NAME \
...
updateAnchorPeers(){
    setGlobalsForPeer0thayson
    peer channel update -o 130.211.113.30:7050 --ordererTLSHostnameOverride orderer.thesis.com -c $CHANNEL_NAME -f \
